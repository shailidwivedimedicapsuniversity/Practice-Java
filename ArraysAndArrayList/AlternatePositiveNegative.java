// Rearrange an unsorted array of positive and negative numbers such that they
//  alternate, starting with a positive, while maintaining their relative order.
//   If one type is exhausted, append the remaining elements as-is.
